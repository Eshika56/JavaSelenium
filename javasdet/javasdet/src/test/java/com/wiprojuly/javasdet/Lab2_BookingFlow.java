...
public class Lab2_BookingFlow {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // ✅ Personal Info
        clickEvent(driver, "//input[@id='p-first-name']", "Eshika");
        clickEvent(driver, "//input[@id='p-last-name']", "Bose");
        clickEvent(driver, "//input[@id='p-email']", "abc@gmail.com");
        clickEvent(driver, "//input[@id='p-phone']", "9099999999");
        clickEvent(driver, "//input[@id='p-address']", "Gurgaon, Haryana, India");

        // ✅ Travellers Info
        clickEvent(driver, "//input[@name='firstname_1']", "Eshika");
        clickEvent(driver, "//input[@name='lastname_1']", "Bose");
        Thread.sleep(500);
        clickEvent(driver, "//input[@name='firstname_2']", "Sunanda");
        clickEvent(driver, "//input[@name='lastname_2']", "Bose");
